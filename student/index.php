                                ...
                                <table id="basic-table" class="table-bordered data-table table table-striped nowrap table-hover" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $result = mysqli_query($con,"SELECT `issue_books`.`issue_date`, `books`.`book_name`, `books`.`book_image`
                                                                        FROM `books`
                                            ...
                                            while($row = mysqli_fetch_assoc($result)){?>
                                                <tr>
                                                    <td><?= $row['book_name'];?></td>
                                                    <td><img style="height:75px;width: 75px;" src="../images/books/<?= $row['book_image'];?>" alt=""></td>
